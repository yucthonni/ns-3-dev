 ...
 * this code
 (https://github.com/nyuwireless-unipd/ns3-mmwave/blob/new-handover/src/spectrum/model/three-gpp-spectrum-propagation-loss-model.h)
 * Modified by NIST <tanguy.ropitault@nist.gov>
 */

#ifndef TRACES_SPECTRUM_PROPAGATION_LOSS_H
#define TRACES_SPECTRUM_PROPAGATION_LOSS_H
...
/**
 * \ingroup spectrum
 * \brief Traces-based Spectrum Propagation Loss Model
 *
 * This class models the frequency dependent propagation phenomena using
 * trace-based channel data. The main method is DoCalcRxPowerSpectralDensity,
 ...
 */
class TracesSpectrumPropagationLossModel : public PhasedArraySpectrumPropagationLossModel
{
  public:
    /**
     * Constructor
     */
    TracesSpectrumPropagationLossModel();

    /**
     * Destructor
     */
    ~TracesSpectrumPropagationLossModel() override;
     ...
     *
     * This function computes the received PSD by applying the trace-based fast fading
...
#endif /* TRACES_SPECTRUM_PROPAGATION_LOSS_H */