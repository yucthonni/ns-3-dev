    ...
    static TypeId tid =
        TypeId("ns3::ProbabilisticV2vUrbanChannelConditionModel")
            ...
            .AddAttribute(
                ...
                MakeEnumAccessor<VehicleDensity>(&ProbabilisticV2vUrbanChannelConditionModel::m_densityUrban),
    ...
    static TypeId tid =
        TypeId("ns3::ProbabilisticV2vHighwayChannelConditionModel")
            ...
            .AddAttribute(
                ...
                "It can be set to Low, Medium or High.",
                EnumValue(VehicleDensity::LOW),
                MakeEnumAccessor<VehicleDensity>(&ProbabilisticV2vHighwayChannelConditionModel::m_densityHighway),
                MakeEnumChecker(VehicleDensity::LOW,
                                "Low",
                                VehicleDensity::MEDIUM,
                                "Medium",
